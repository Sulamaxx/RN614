	...
	<section>
		<section class="home_main">
			<div class="home-content">
				<h3>Your Ultimate Destination for</h3>
				<p class="h1">Laptops!</p>
				<br><br>
				<p>Powerful laptops curated for your needs, ready to elevate your every endeavor</p>
				<div class="icon">
			...
			<div id="cimg">
				<img id="slide-6" src="images/1.jpeg" alt="lap1">
			</div>
		</section>
